    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal rounded-none border border-transparent hover:bg-accent hover:text-accent-foreground hover:border-foreground/20 aria-selected:opacity-100 transition-colors",
        ),
        ...
        day_today: "bg-transparent text-foreground font-semibold underline underline-offset-4",
        day_outside:
