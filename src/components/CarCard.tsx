    ...
    <div className="group bg-background flex flex-col h-full">
      ...
      <div className="px-4 md:px-6 pb-4 md:pb-6">
        <a
          ...
          className="w-full inline-flex items-center justify-center gap-1.5 border border-border text-muted-foreground hover:text-foreground hover:border-foreground/30 px-3 py-2 text-[10px] font-body font-medium tracking-[0.15em] uppercase transition-all"
        >
