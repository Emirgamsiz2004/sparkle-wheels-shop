    ...
    <AnimatePresence>
      {visible && (
        ...
        >
          <button
            onClick={handleClick}
            className="group/cta relative flex items-center gap-2.5 bg-foreground text-background px-5 py-3 shadow-lg shadow-black/30 overflow-hidden transition-all duration-500"
          >
