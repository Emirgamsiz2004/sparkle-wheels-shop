      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-display font-bold">
            Wij staan <span className="text-gradient-gold">klaar</span>
          </h2>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {contactInfo.map((item, i) => (
            <motion.a
              ...
              className="group bg-card border border-border hover:border-primary/50 p-8 text-center transition-all duration-300"
            >
              <item.icon className="w-8 h-8 text-primary mx-auto mb-4 group-hover:scale-110 transition-transform" />
              <p className="text-xs tracking-widest uppercase font-body text-muted-foreground mb-2">
                {item.label}
              </p>
        ...
        >
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-gradient-gold text-primary-foreground px-8 py-3.5 text-sm font-semibold tracking-wider uppercase hover:shadow-gold transition-all duration-300"
          >
