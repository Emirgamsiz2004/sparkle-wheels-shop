    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
        ...
        <SummaryCard
          icon={TrendingUp}
          label="Hoogste marge"
          value={hoogste ? formatEuro(hoogste.brutoMarge!) : "—"}
          sub={hoogste ? `${hoogste.v.merk} ${hoogste.v.model}` : undefined}
        />
        <SummaryCard
          icon={TrendingDown}
          label="Laagste marge"
          value={laagste ? formatEuro(laagste.brutoMarge!) : "—"}
          sub={laagste ? `${laagste.v.merk} ${laagste.v.model}` : undefined}
        />
        <SummaryCard
          icon={Award}
          label="Totale bruto winst"
          value={formatEuro(totaalWinst)}
            ...
            <table className="w-full text-sm">
              <thead className="bg-secondary/40 text-muted-foreground text-xs uppercase tracking-wide">
                <tr>
                  ...
                  <th className="text-right px-4 py-2.5 font-medium">Verkoopprijs</th>
                  <th className="text-right px-4 py-2.5 font-medium">Bruto marge</th>
