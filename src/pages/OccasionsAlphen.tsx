...
const OccasionsAlphen = () => (
  <CityLandingPage
    ...
    intro={`Bent u op zoek naar een kwalitatieve occasion in de omgeving van Alphen aan den Rijn? Platin Automotive in Roelofarendsveen ligt op slechts 10 minuten rijden — een kleine omweg voor een grote zekerheid.\n\nWij zijn een erkend familiebedrijf gespecialiseerd in goed uitgeruste occasions. Geen instapmodellen, maar auto's met een mooie specificatie waar u trots op rijdt. Elke auto in ons aanbod is bewust geselecteerd — wij verkopen alleen auto's die we zelf ook zouden kopen.`}
